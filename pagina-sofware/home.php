    ...
    <body>
        <div class="fondo-home">
            ...
            <div style="width: 100vw;height: 100vh;display: flex;justify-content: center;align-items: center;background: #00000070;"> 
                <label style="font-size:2em; color:#fff; text-align: center; letter-spacing:2px;"> SOLINCA EXELENCIA Y TECNOLOGÍA <br> de fabricación en repuestos para lineas de envasado</label>
            </div>
        </div>
        <!-- <div class="RI">
